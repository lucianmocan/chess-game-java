...
public class Rook extends LongMoves{

    public Rook(Color color) throws IOException {
        this.color = color;
        if (this.color == Color.WHITE){
            File f = new File("src/main/resources/images/rook_white.png");
            image = new Image(new FileInputStream(f.getCanonicalPath()));
        }
        else {
            File f = new File("src/main/resources/images/rook_dark.png");
            image = new Image(new FileInputStream(f.getCanonicalPath()));
        }
    }
